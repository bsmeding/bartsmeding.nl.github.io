...
[ansible_cicd](docker/docker_container_ansible_cicd.md)-images bevatten Ansible, Molecule, ansible-lint, netwerkautomatiseringstools en CMDB-testdependencies voor CI/CD van rollen en playbooks.

| Image | Basis | CI-status | Downloads |
| ----- | ----- | --------- | --------- |
...
[netdevops_cicd](docker/docker_container_netdevops_cicd.md)-images bevatten Python NetDevOps-tools zoals Netmiko, Scrapli, Nornir, NAPALM, API-clients en helpers voor configuratievalidatie.
...
[aiops_cicd](docker/docker_container_aiops_cicd.md)-images bevatten LLM-clients, tools voor prompt- en agenttests, validatie van gestructureerde output, RAG-evaluatie en operationele replay.
