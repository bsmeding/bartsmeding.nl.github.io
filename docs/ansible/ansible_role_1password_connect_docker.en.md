# Ansible Role: 1password_connect_docker (`bsmeding.1password_connect_docker`)
...
## Quick details
- **Role directory:** `ansible_role_1password_connect_docker`
- **Minimum Ansible version:** `2.10`
- **Supported platforms:** See repository metadata.
- **Galaxy tags:** n/a
...
- hosts: all
  become: true
  roles:
    - role: bsmeding.1password_connect_docker
```
